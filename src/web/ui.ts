 ...
 */
export function updatePasswordModeUI(elements: AppElements): void {
 ...
 */
export function updateUserIdModeUI(elements: AppElements): void {
 ...
 */
export function updateCrackTimeUI(entropyBits: number, elements: AppElements): void {
 ...
 */
export function updateStrengthUI(entropyBits: number, elements: AppElements): void {
 ...
 */
export function clearPasswordUI(elements: AppElements): void {
